 ...
 * 4) isset, однако, работает для проверки наличия дочерних листов: @see df_xml_empty_child()
 ...
 *			</Склад>
 *		</Остаток>
 * Если здесь сделать xpath `Остаток/Склад/Количество`, то для узла «147» @see df_xml_empty($e) вернёт `false`.
 ...
 */
function df_xml_empty_child(X $e, string $child):bool {return isset($e->{$child});}