 ...
 * В то же время, несмотря на `E_WARNING`, метод всё-таки возвращает результат; правда, без недопустимых значений:
 * при подавлении `E_WARNING` dfa_unique_fast(array(1, 2, 2, 3, null)) вернёт: array(1, 2, 3).
