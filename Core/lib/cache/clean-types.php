 ...
 */
function df_cache_clean_blocks() {df_cache_clean_type(TBlock::TYPE_IDENTIFIER);}

/**
 * 2021-09-22
 * @used-by df_cfg_save_cc()
 */
function df_cache_clean_cfg() {df_cache_clean_type(TConfig::TYPE_IDENTIFIER);}

/**
 * 2021-09-22
 * @used-by \Df\Directory\Plugin\Model\Currency::afterSaveRates()
 */
function df_cache_clean_pages() {df_cache_clean_type(TPage::TYPE_IDENTIFIER);}
 ...
 * @param string $t
 */
function df_cache_clean_type($t) {df_cache_type_list()->cleanType($t);}